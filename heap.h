...
class heap
{
  public:
     ...
     */
    heap(const std::vector<Node*>& elems);
     ...
     */
    void updateElem(const size_t & idx, Node* elem);
    ...
    void getElems(std::vector<Node*> & heaped) const;
    ...
    // friend class HeapNodeDescriptor<Node*, Compare>;
